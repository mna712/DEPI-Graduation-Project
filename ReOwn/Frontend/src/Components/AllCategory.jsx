...
function AllCategory() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Categories Content */}
      <main className="w-full px-4 py-4 pb-8 mx-auto max-w-7xl">
        {categories.map((category, index) => (
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 gap-3 sm:gap-0">
              <h2 className="pb-1 text-xl sm:text-2xl lg:text-3xl font-bold text-green-800 transition-all duration-200 border-b-2 sm:border-b-4 border-green-800 cursor-default hover:border-green-500">
                {category.name}
              </h2>
              <button
                onClick={() => handleViewMore(category.id)}
                className="flex items-center gap-1 text-xs sm:text-sm font-medium text-teal-600 transition-all duration-200 hover:text-teal-700 hover:gap-2"
              >
                View more
            ...
            <div className="relative group">
              ...
              <button
                ...
                className="absolute left-0 z-10 p-1.5 sm:p-2 -ml-2 sm:-ml-4 transition-all duration-300 -translate-y-1/2 rounded-full shadow-lg opacity-0 top-1/2 bg-white/90 hover:bg-yellow-400 group-hover:opacity-100 hover:scale-110"
              ...
              >
                {category.products.map((product) => (
                  <div
                    key={product.id}
                    className="flex-shrink-0 w-[calc(100%-10px)] xs:w-[calc(50%-10px)] sm:w-[calc(33.333%-14px)] md:w-[calc(33.333%-14px)] lg:w-[calc(25%-15px)]"
                  >
                    <div
                    ...
                    >
                      ...
                      <div className="relative mb-3">
                        ...
                        {/* Product Image */}
                        <div className="relative flex items-center justify-center w-full overflow-hidden bg-gray-100 rounded-lg h-40 sm:h-48 lg:h-52">
                          <img
                            src={product.image}
                            alt={product.name}
                      ...
                      <div className="flex flex-col flex-1">
                        <h3 className="mb-2 text-sm sm:text-base lg:text-lg font-semibold text-gray-800 transition-colors duration-200 line-clamp-2 group-hover/card:text-green-800">
                          {product.name}
                        </h3>
                        <p className="mb-3 sm:mb-4 text-base sm:text-lg lg:text-xl font-bold text-green-800">
                          {product.price}
                        </p>
                        {/* Buttons */}
                        <div className="flex gap-2 sm:gap-3 mt-auto">
                          <button
                            ...
                            className="flex items-center justify-center flex-1 py-2 sm:py-2.5 text-white transition-all duration-200 bg-green-800 rounded-full hover:bg-yellow-400 hover:text-black shadow-md hover:shadow-lg hover:scale-105"
                          ...
                          >
                            <BsChatSquareDots size={18} className="sm:w-5 sm:h-5" />
                          </button>
                        </div>
                      </div>
                    </div>
              ...
              <button
                ...
                className="absolute right-0 z-10 p-1.5 sm:p-2 -mr-2 sm:-mr-4 transition-all duration-300 -translate-y-1/2 rounded-full shadow-lg opacity-0 top-1/2 bg-white/90 hover:bg-yellow-400 group-hover:opacity-100 hover:scale-110"
