    ...
    <div className="px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="grid w-full grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {products.map((product, index) => (
          <div
            key={product.id}
            className="relative flex flex-col p-5 transition-all duration-300 bg-white shadow-md rounded-xl hover:shadow-xl hover:-translate-y-1 group/card animate-fadeIn"
          ...
          >
            ...
            <div className="relative mb-3">
              <button
                ...
                aria-label={likedProducts[product.id] ? "Remove from favorites" : "Add to favorites"}
              >
